...
bucket_name = "amena-input-image-dev"
object_key = "test-movie"
...
def output_3d_photo(verts, colors, faces, Height, Width, hFov, vFov, tgt_poses, video_traj_types, ref_pose,
    ...
    for video_pose, video_traj_type in zip(videos_poses, video_traj_types):
        ...
        video_path = os.path.join(output_dir, video_basename + video_traj_type + '.mp4')
        clip.write_videofile(video_path, fps=config['fps'])

    return normal_canvas, all_canvas, video_path
